...
- sugar_estimate: Strictly ONE WORD indicating estimated sugar level from ingredients: "Low", "Medium", "High", or "Nil" (or "0g" if no sugar). Do NOT include explanations, extra words, or sentences.
